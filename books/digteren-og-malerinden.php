...
<?php macro_open_head(); ?>
  ...
  padding-left: 15px;"-->
			<img src="../img/books/digteren-og-malerinden-200.jpg" class="img-rounded" alt="Digteren Og Malerinden">
		</div>
		<div class="col-md-6">
			<h2 class="text-left">Digteren Og Malerinden</h2>
			<p class="lead">Så kom den store roman om B. S. Ingemann fra Marianne Hesselholt og Ancethe. Det handler om kunsterparet Bernhard og Lucie Ingemann...</p>
		</div>
		<div class="col-md-4">
			<!--div style="float: right; padding-right: 15px;
  padding-left: 15px;"-->
			...
			<a href="mailto:marianne@hesselholt.com?subject=K&oslash;b af Digteren Og Malerinden">marianne@hesselholt.com</a>
			</p>
			<a href="mailto:marianne@hesselholt.com?subject=K&oslash;b af Digteren Og Malerinden" class="btn btn-info" role="button">
			Bestil for kr 120,-
			</a>
		</div>
	  </div>
	...
	<p>Som det fremgår af bibliotekernes lektørudtalelse er denne bog et sammendrag af de tre tidligere udkomne bøger om Ingemann og Lucie, dog med markante forskelle: Jeg har i mellemtiden fået kendskab til Lucies skitsebog, og med denne nye viden har jeg kunnet udbygge portrættet af maleren Lucie. Digteren og Malerinden er desuden komponeret anderledes end de små bøger, idet mange flere autentiske tekster fra Guldalderen optræder i romanen.</p>

	<p>Til yderligere at belyse dette kan man læse Niels Højlunds anmeldelse af bogen i Weekendavisen:</p>
  ...
  padding:10px 0 0 10px;">
	...
	<div class="container">
	<button type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo1">Læs kapitel 11...</button>
